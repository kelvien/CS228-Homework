...
public class JUNIT
{
	...
	public void illegalRebalance()
	{
		...
		bst.add(1);
		BalancedBSTSet<Integer>.Node fakeNode = bst.new Node(new Integer(1), null);
	...
	@Test
	public void add453210forceBalanceNotAtRoot()
	{
		BalancedBSTSet<Integer> bst = new BalancedBSTSet<Integer>();
		bst.add(4);
		bst.add(5);
	...
	@Test
	public void add321autoBalanceAtLowAlpha()
	{
	...
	@Test
	public void add3210noAutoBalanceAtHighAlpha()
	{
	...
	@Test
	public void add3210balanceAtRoot_rootTest()
	{
		BalancedBSTSet<Integer> bst = new BalancedBSTSet<Integer>(true);
		bst.add(3);
		bst.add(2);
		bst.add(1);
		bst.add(0);
		Assert.assertEquals("1", bst.root().toString());
	}
	
	@Test
	public void rightSidebalanceAtRoot_rootTest()
	{
		BalancedBSTSet<Integer> bst = new BalancedBSTSet<Integer>(true);
		bst.add(0);
		bst.add(1);
